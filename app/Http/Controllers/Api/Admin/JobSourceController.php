...
class JobSourceController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:20|unique:tblm_jobsource,description'
        ],
        [
            'description.required' => 'The Job Source description is required.',
            'description.unique' => 'The Job Source description already exists.',
            'description.max' => 'The Job Source description must not exceed 20 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Job Source description is required.',
            'description.prohibited' => 'The Job Source description already exists.',
            'description.max' => 'The Job Source description must not exceed 20 characters.',
        ]);
