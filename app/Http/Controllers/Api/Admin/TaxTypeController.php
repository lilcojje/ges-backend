...
class TaxTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'short_desc' => 'required|max:10|unique:tblm_tax_type,short_desc',
            'long_desc' => 'required|max:50|unique:tblm_tax_type,long_desc'
        ],
        [
            ...
            'long_desc.required' => 'The Tax Type Description is requried.',
            'long_desc.unique' => 'The Tax Type Description already exist.',
            'long_desc.max' => 'The Tax Type description must not exceed 50 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            ...
            'short_desc.max' => 'The Tax Type Code must not exceed to 10 characters.',
            'long_desc.required' => 'The Tax Type Description is requried.',
            'long_desc.prohibited' => 'The Tax Type Description already exist.',
            'long_desc.max' => 'The Tax Type description must not exceed 50 characters.',
        ]);
