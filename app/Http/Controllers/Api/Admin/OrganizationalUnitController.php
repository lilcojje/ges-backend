...
class OrganizationalUnitController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'ou_name' => 'required|max:50|unique:tblm_organizational_unit,ou_name',
            'registered_legal_name' => 'required|max:50|unique:tblm_organizational_unit,registered_legal_name',
