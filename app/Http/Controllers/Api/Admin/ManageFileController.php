...
class ManageFileController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:50|unique:tblm_201_filetype,description'
        ],
        [
            'description.required' => 'The File Type description is required.',
            'description.unique' => 'The File Type description already exists.',
            'description.max' => 'The File Type description must not exceed 50 characters.',
        ]);
