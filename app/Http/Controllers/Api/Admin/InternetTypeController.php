...
class InternetTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:50|unique:tblm_internet_type,description'
        ],
        [
            'description.required' => 'The Internet Type description is required.',
            'description.unique' => 'The Internet Type description already exists.',
            'description.max' => 'The Internet Type description must not exceed 50 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Internet Type description is required.',
            'description.prohibited' => 'The Internet Type description already exists.',
            'description.max' => 'The Internet Type description must not exceed 50 characters.',
        ]);
