...
class SkillLevelController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:50|unique:tblm_skill_level,desc'
        ],
        [
            'description.required' => 'The Skill Level description is required.',
            'description.unique' => 'The Skill Level description already exists.',
            'description.max' => 'The Skill Level description must not exceed 50 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Skill Level description is required.',
            'description.prohibited' => 'The Skill Level description already exists.',
            'description.max' => 'The Skill Level description must not exceed 50 characters.',
        ]);
