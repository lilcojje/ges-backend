...
class InvoiceItemTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:50|unique:tblm_invoice_item_type,description',
            'percentage' => 'required_if:is_percentage,true|numeric|nullable'
        ],
        [
            'description.required' => 'The Invoice Item Type description is required.',
            'description.unique' => 'The Invoice Item Type description already exists.',
            'description.max' => 'The Invoice Item Type description must not exceed 50 characters.',
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Invoice Item Type description is required.',
            'description.prohibited' => 'The Invoice Item Type description already exists.',
            'description.max' => 'The Invoice Item Type description must not exceed 10 characters.',
            'percentage.required_if' => 'The Percentage is required.',
            'percentage.numeric' => 'The Percentage should only contain numbers.',
        ]);
