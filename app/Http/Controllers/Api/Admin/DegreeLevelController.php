...
class DegreeLevelController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:50|unique:tblm_degree_level,description'
        ],
        [
            'description.required' => 'The Degree Level description is required.',
            'description.unique' => 'The Degree Level description already exists.',
            'description.max' => 'The Degree Level description must not exceed 50 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Degree Level description is required.',
            'description.prohibited' => 'The Degree Level description already exists.',
            'description.max' => 'The Degree Level description must not exceed 50 characters.',
        ]);
