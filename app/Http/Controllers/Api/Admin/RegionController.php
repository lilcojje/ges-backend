...
class RegionController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            ...
            'description' => 'required|max:20|unique:tblm_region,description'
        ],
        [
            'country_id.required' => 'The Country is required.',
            'country_id.exists' => 'The selected Country is invalid.',
            'description.unique' => 'The Region already exists.',
            'description.required' => 'The Region description is required.',
            'description.max' => 'The Region description must not exceed 20 characters.',
        ]);
