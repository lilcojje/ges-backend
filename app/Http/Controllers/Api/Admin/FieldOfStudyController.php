...
class FieldOfStudyController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:50|unique:tblm_field_of_study,description'
        ],
        [
            'description.required' => 'The Field of Study description is required.',
            'description.unique' => 'The Field of Study description already exists.',
            'description.max' => 'The Field of Study description must not exceed 50 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Field of Study description is required.',
            'description.prohibited' => 'The Field of Study description already exists.',
            'description.max' => 'The Field of Study description must not exceed 50 characters.',
        ]);
