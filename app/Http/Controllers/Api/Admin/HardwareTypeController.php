...
class HardwareTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:50|unique:tblm_comp_hardwaretype,description'
        ],
        [
            'description.required' => 'The Hardware Type description is required.',
            'description.unique' => 'The Hardware Type description already exists.',
            'description.max' => 'The Hardware Type description must not exceed 50 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Hardware Type description is required.',
            'description.prohibited' => 'The Hardware Type description already exists.',
            'description.max' => 'The Hardware Type description must not exceed 50 characters.',
        ]);
