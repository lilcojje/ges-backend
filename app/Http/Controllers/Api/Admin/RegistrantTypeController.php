...
class RegistrantTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            'description' => 'required|max:20|unique:tblm_registrant_type,description'
        ],
        [
            'description.required' => 'The Registrant Type description is required.',
            'description.unique' => 'The Registrant Type description already exists.',
            'description.max' => 'The Registrant Type description must not exceed 20 characters.',
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        [
            'description.required' => 'The Registrant Type description is required.',
            'description.prohibited' => 'The Registrant Type description already exists.',
            'description.max' => 'The Registrant Type description must not exceed 20 characters.',
        ]);
