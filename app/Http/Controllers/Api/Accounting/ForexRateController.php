...
class ForexRateController extends Controller
{
    ...
    { 
        ...
        $forex_rate = ForexRate::
            ...
            DB::raw('DATE_FORMAT(tblm_forex_for_client_invoice.datecreated, "%b %d, %Y %r") as date_created')])
            ...
            ->orderBy('tblm_forex_for_client_invoice.id', 'DESC')->paginate($request->limit ? $request->limit : ForexRate::count());
